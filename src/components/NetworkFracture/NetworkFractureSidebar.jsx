...
const THEME = PROJECTS.networkfracture;
...
export default function NetworkFractureSidebar({ t }) {
  ...
  const handleRepoClick = () => {
    window.open('https://github.com/roizunza/urban-data-pipelines/tree/main/02_network_fracture', '_blank');
  };
  ...
  const s = {
    ...
    li: { marginBottom: '8px' },
    highlight: { color: '#FFFFFF', fontWeight: '700' }, 
    repoBtn: {
      display: 'flex',
      alignItems: 'center',
